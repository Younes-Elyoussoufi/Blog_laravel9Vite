    ...
    <div class="container custom-container">
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="baner__img text-center text-xxl-end">
                    <img src="{{asset('frontend/assets/img/banner/youtube.jfif')}}" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".4s">I'm a YOUNES.BLOG  based product design & visual designer focused on crafting clean & user‑friendly experiences</p>
    ...
    <div class="container">
        ...
        <div class="row gx-0 services__active">
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a href="/services-details"><img src="{{asset('frontend/assets/img/images/services_img04.jpg')}}" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                        ...
                        <h3 class="title"><a href="/services-details">Visual Design</a></h3>
                        <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
                        <ul class="services__list">
                            <li>User Research & Testing</li>
                            <li>UX Design</li>
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    <div class="services__thumb">
                        <a href="/services-details"><img src="{{asset('frontend/assets/img/images/services_img03.jpg')}}" alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                            <img class="light" src="{{asset('frontend/assets/img/icons/services_light_icon02.png')}}" alt="">
                        ...
                        <div class="portfolio__active">
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img01.jpg')}}" alt="">
                                </div>
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img02.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img03.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img04.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img05.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                                    <span>Web Development</span>
                                    <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img06.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                                    <span>Web Development</span>
                                    <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{asset('backend/assets/img/portfolio/portfolio_img07.jpg')}}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                                    <span>Web Development</span>
                                    <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                        ...
                        <div class="testimonial__item">
                            ...
                            <div class="testimonial__content">
                                ...
                                <div class="testimonial__avatar">
                                    <span>YOUNES.BLOG  De Wiliamson</span>
                                </div>
                            </div>
                        </div>
                        <div class="testimonial__item">
